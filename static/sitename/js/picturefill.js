...
!(function (a) {
	...
	(function (a, b, c) {
		...
		function g(a, b, c, d) {
			var e, f, g, h;
			return (
				'saveData' === B.algorithm ? (a > 2.7 ? (h = c + 1) : ((f = b - c), (e = Math.pow(a - 0.6, 1.5)), (g = f * e), d && (g += 0.1 * e), (h = a + g))) : (h = c > 1 ? Math.sqrt(a * b) : a),
				h > c
			);
		}
		function h(a) {
			...
			(s.applySetCandidate = function (a, b) {
				if (a.length) {
					...
					if (
						...
						l && l.set === a[0].set && ((n = F && !b.complete && l.res - 0.1 > p), n || ((l.cached = !0), l.res >= p && (h = l))),
						!h)
					)
				...
				(j.src === c || d.src) && ((j.src = w.call(a, 'src')), j.src ? x.call(a, C, j.src) : y.call(a, C)),
					...
					j.srcset
						? ((f = { srcset: j.srcset, sizes: w.call(a, 'sizes') }),
						  ...
						  g || !j.src || k(j.src, f) || f.has1x || ((f.srcset += ', ' + j.src), f.cands.push({ url: j.src, d: 1, set: f })))
		...
		(a.picturefill = ba),
			...
			s.supPicture ||
				(A['image/webp'] = e('image/webp', 'data:image/webp;base64,UklGRkoAAABXRUJQVlA4WAoAAAAQAAAAAAAAAAAAQUxQSAwAAAABBxAR/Q9ERP8DAABWUDggGAAAADABAJ0BKgEAAQADADQlpAADcAD++/1QAA=='));
	})(window, document);
